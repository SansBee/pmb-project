...
class PersyaratanDokumen extends Model
{
    ...
    // Tambah contoh format yang valid
    const FORMAT_EXAMPLES = [
        'pdf' => 'Contoh: dokumen.pdf',
        'jpg,jpeg,png' => 'Contoh: foto.jpg, foto.png',
        'pdf,jpg,jpeg,png' => 'Contoh: dokumen.pdf, foto.jpg'
    ];

    // Tambah scope untuk filter
    ...
    public function getFormatExampleAttribute()
    {
        return self::FORMAT_EXAMPLES[$this->format_file] ?? '';
    }
}